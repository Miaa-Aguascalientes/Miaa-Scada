    ...
    for id_p, info in mapa_pozos_dict.items():
        ...
        <div style="background: #050505; color: white; padding: 15px; border-radius: 12px; width: 350px; border: 1px solid {info['color_final']}; font-family: sans-serif;">
            ...
            <div style="font-size: 11px; margin-bottom: 10px;">
                <div style="color: #888; font-size: 10px; margin-bottom: 4px;">HIDRÁULICA</div>
                💧 Caudal: <b>{q:.2f} L/s</b> <br>
                🚀 Presión: <b>{p:.2f} kg</b>
            </div>
            <div style="font-size: 11px; margin-bottom: 10px;">
                <div style="color: #888; font-size: 10px; margin-bottom: 4px;">NIVELES</div>
                📏 Sumergencia: <b>{sumer:.1f} m</b> | 📉 Dinámico: <b>{dinam:.1f} m</b> <br>
                🔋 Tanque: <b>{tanq:.1f} mts</b>
            </div>
            <div style="font-size: 10px;">
                <div style="color: #888; font-size: 10px; margin-bottom: 4px;">HORARIOS</div>
                ▶️ Arranque: {h_arr_fmt} | ⏹️ Paro: {h_par_fmt}
            </div>
        </div>
        """
