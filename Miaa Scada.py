    ...
    for id_p, info in mapa_pozos_dict.items():
        ...
        <div style="background: #050505; color: white; padding: 15px; border-radius: 12px; width: 380px; border: 1px solid {info['color_final']}; font-family: sans-serif;">
            ...
            <div style="margin-bottom: 10px;">
                ...
                <div style="display: flex; font-size: 11px;"><span>📉 Dinámico: <b>{dinam:.1f} m</b></span><span style="color:#FFFF00; font-size:8px; margin-left:auto;">{f_d}</span></div>
            ...
            <div style="margin-bottom: 10px;">
                ...
                <table style="width: 100%; font-size: 10px; border-collapse: collapse;">
                    ...
                    <tr style="border-bottom: 1px solid #222;"><td>L2-L3</td><td><b>{v[1][0]:.1f}V</b></td><td><b>{a[1][0]:.1f}A</b></td></tr>
                    <tr><td>L1-L3</td><td><b>{v[2][0]:.1f}V</b></td><td><b>{a[2][0]:.1f}A</b></td></tr>
                </table>
            </div>

            <div style="font-size: 10px; color: #888; border-top: 1px solid #222; padding-top: 5px;">
